...
plot3 <- function() {
  ...
  plot(household_power_consumption_ss$date_time, household_power_consumption_ss$Sub_metering_1,
       type = "l", 
       xlab = "",
       ylab = "Enery sub metering")
  
  lines(household_power_consumption_ss$date_time, household_power_consumption_ss$Sub_metering_2, 
        col="red")
  
  lines(household_power_consumption_ss$date_time, household_power_consumption_ss$Sub_metering_3, 
        col="blue")
